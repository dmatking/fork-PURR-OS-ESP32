...
void touch_cst816s_deinit() {}
#include "purr_sys_drv.h"
static sys_drv_t s_cst816s_drv = {
    .name="touch:cst816s",.subsystem="touch",.enabled=false,
    .init=touch_cst816s_init,.tick=NULL,.deinit=touch_cst816s_deinit,.cmd=NULL
};
void touch_cst816s_drv_register(bool enabled){s_cst816s_drv.enabled=enabled;sys_drv_register(&s_cst816s_drv);}
