...
# PURR OS — Heltec WiFi LoRa 32 V3 build script
# ESP32-S3, 8MB flash, SSD1306 OLED, SX1262 LoRa (default).
#
# Usage:
#   .\build_heltec.ps1                              # interactive menu
#   .\build_heltec.ps1 -Build -Flash COM5
#   .\build_heltec.ps1 -Build -Mini -NoLora -Flash COM5
#   .\build_heltec.ps1 -Build -LoraKernel rak3172 -Flash COM5
#   .\build_heltec.ps1 -Build -WithMesh -Clean -Flash COM5
...
$pyArgs = [System.Collections.Generic.List[string]]@('--target', 'heltec')
