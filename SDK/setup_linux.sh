...
SDK_SCRIPT="$(cd "$(dirname "$0")" && pwd)/Builder/sdk.sh"
...
echo ""
echo "  2. Build for your CYD variant:"
echo "     cd $(dirname "$0")"
echo "     ./Builder/sdk.sh --target cyd_s028r --build"
echo ""
echo "  3. Flash to device (after building):"
echo "     ./Builder/sdk.sh --target cyd_s028r --flash /dev/ttyUSB0"
echo ""
echo "  4. Or use interactive mode:"
echo "     ./Builder/sdk.sh"
echo ""
echo "For more info, see LINUX_BUILD.md"
echo ""
