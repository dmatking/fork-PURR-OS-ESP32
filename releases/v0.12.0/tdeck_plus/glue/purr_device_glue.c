// purr_device_glue.c — auto-generated by purrstrap for tdeck_plus
// Device: tdeck_plus  Chip: esp32s3
...
#define CONFIG_DRV_TOUCH_SDA_PIN 18
#define CONFIG_DRV_TOUCH_SCL_PIN 8
#define CONFIG_DRV_TOUCH_INT_PIN 16
