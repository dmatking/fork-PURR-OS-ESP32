...
void touch_gt911_deinit() {}
#include "purr_sys_drv.h"
static sys_drv_t s_gt911_drv = {
    .name="touch:gt911",.subsystem="touch",.enabled=false,
    .init=touch_gt911_init,.tick=NULL,.deinit=touch_gt911_deinit,.cmd=NULL
};
void touch_gt911_drv_register(bool enabled){s_gt911_drv.enabled=enabled;sys_drv_register(&s_gt911_drv);}
