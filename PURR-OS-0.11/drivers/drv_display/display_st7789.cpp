...
static sys_drv_t s_st7789_drv = {
    .name="display:st7789",.subsystem="display",.enabled=false,
    .init=display_st7789_init,.tick=display_st7789_tick,.deinit=display_st7789_deinit,.cmd=NULL
};
void display_st7789_drv_register(bool enabled){s_st7789_drv.enabled=enabled;sys_drv_register(&s_st7789_drv);}
