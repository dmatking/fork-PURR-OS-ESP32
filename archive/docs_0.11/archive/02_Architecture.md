...
└── components/
    ...
    ├── drv_shell/               ← USB serial REPL (esp_console) + drvmgr command
...
└── kernel/
    ...
    └── modules/
        ...
        ├── purr_drv             ← PDL driver manager (load/tick/unload .drv scripts)
        ├── purr_drv_interp      ← PDL interpreter (lexer + parser + evaluator)
